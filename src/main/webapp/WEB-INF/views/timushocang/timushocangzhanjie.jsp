...
<script type="text/javascript">
		...
		/*  alert("剩余错题数为："+ids); */
		 if(ids == 0){
			 layer.confirm('温故而知新，将错题再复习一遍，才能让知识更加巩固哦~', {
				...
				window.location.href="../timushocangzhangjie/practice?knowledge_Id="+knowledge_Id+"&kemu="+kemu+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&kemuZYHXY="+kemuZYHXY+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"";
			}
	}
	...
	function switchs(){//切换科目（回到科目选择页面）
			/* alert("微信id："+openid); *///
			window.location.href="../timushocangzhangjie/switch?openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"";
	}
