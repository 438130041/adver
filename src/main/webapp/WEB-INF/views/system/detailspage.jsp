    ...
    <div class="warp">
        ...
        <div class="details">
             ...
             <div class="detailed_s">  
                 ...
                 <div class="answer"> <span id="answer">${correctnumber}</span>/<span id="total">5</span><br><p>正确题</p></br></div>
...
<script  type="text/javascript">
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "中药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     $("#active1").css("display","block");
	    	       ...
	    	       if(percentage == 100){
						if(storage["Addintegral1"] == null || storage["Addintegral1"] == ""){
							$.ajax({
								...
								success:function(data){
									if(data.type == 'success'){
										...
										//提示
										popTipShow.confirm('提示','您的答题正确率是100%，恭喜获得5积分!',['确定'],
					    						function(e){
					    						  //callback 处理按钮事件
						...
						var  Addintegral1 =  "Addintegral1";
		    	    	storage["Addintegral1"] = Addintegral1;
	         ...
	         if(Knowledge_Name == "中药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral2"] == null || storage["Addintegral2"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral2 =  "Addintegral2";
		    	       storage["Addintegral2"] = Addintegral2;
		    	       $("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    	     }
	         ...
	         if(Knowledge_Name == "中药学综合知识与技能" ){
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral3"] == null || storage["Addintegral3"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral3 =  "Addintegral3";
	    	    	   storage3["Addintegral3"] = Addintegral3;
	    	    	   $("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    	     }
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral4"] == null || storage["Addintegral4"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral4 =  "Addintegral4";
	    	    	   storage["Addintegral4"] = Addintegral4;
	    	    	   $("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    		  }
	     }
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 2000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     var  lv2state = $(".lv2state").text();//礼物领取状态
					  		     var  lv3state = $(".lv3state").text();//礼物领取状态
								window.location.href="../practice/practice?subjectsid="+subjectsid+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&days="+days+"&dateTime="+dateTime+"&integral="+integral+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
    ...
    //在做一次
      function  again(){
      	  window.location.href="../aging/aging?Knowledge_Name="+Knowledge_Name+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&names="+names+"&days="+dayss+"&dateTime="+dateTime+"&integral="+integrals+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"";   
    }  
     //题目解析
      function  jiexi(){
    	 console.log("跳转进解析");
    	 var tixing = "中药";
          window.location.href="../jiexi/jiexi?correctnumber="+correctnumber+"&percentage="+percentage+"&int_second="+int_second+"&Knowledge_Name="+Knowledge_Name+"&queanswer="+queanswer+"&answers="+answers+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&tixing="+tixing+"&days="+dayss+"&dateTime="+dateTime+"&integral="+integrals+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"";   
      }  
