 ...
 <script  type="text/javascript">
    ...
    $("#integral").click(function(){//积分兑换
 	...
 	$("#href").click(function(){//点击开始(做题赚取积分)
 		       ...
 		       /* 	 $("#href").attr("href","../system/zhuyemian?nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"");  */ 
 		           $("#href").attr("href","../zhuyemian/zhuyemian?nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"");  
 		        /*学历推广  *//*  $("#href").attr("href","../xuelituijian/xuelituijian?nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+""); */  
    		...
    		//单独的分享页面
 			...
 			//Angularjs测试
 		          $("#href").attr("href","../angularjs/angularjstiaozhuanshoye");
 	})
