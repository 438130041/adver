...
<body>
	...
	<div  class="state">${state}</div><!-- 礼物领取状态 -->
    ...
    <div>
        <div class="choice">
            ...
            <div class="course">
            	...
            	<div ><a  class="zy"  id="ZY">中药学专业知识一</a></div>
            	<div ><a  class="ze"  id="ZE">中药学专业知识二</a></div>
            	<div ><a  class="zh"  id="ZH">中药学综合知识与技能</a></div>
         </div>
        </div>
    </div>
 	...
 	function  QueInIt(){
		  /*  var  word =  $(".course").text();
		   ...
		   $("#FG").click(function(){
			  ...
			  var subjectsid= $(".course  #FG").prop("id");//中药题型名（字母）
			 ...
			 if(id == "FG"){
				$("#btn").click(function(){
				 $("#jump").attr("href","../practice/practice?subjectsid="+subjectsid+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&days="+days+"&dateTime="+dateTime+"&integral="+integral+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"");   //后台在根据装题型的div的id的不同跳转的页面不同
				})
			 }    
		   })
		   //中药学专业知识一
			...
			if(id  == "ZY"){
				$("#btn").click(function(){
					  $("#jump").attr("href","../practice/practice?subjectsid="+subjectsid+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&days="+days+"&dateTime="+dateTime+"&integral="+integral+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"");   
					 /* $("#jump").attr("href","../tfcpractice/practice?subjectsid="+subjectsid+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&days="+days+"&dateTime="+dateTime+"&integral="+integral+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"");    */
				})
			}
		   })
		   //中药学专业知识二
