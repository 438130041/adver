    ...
    <div class="modal-content">
     ...
     <script  type="text/javascript">
  	 	...
  	 	//缓存当前时间
  	 		...
  	 		if(storagedateTime["storagedateTime"] != dateTime){
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral5"] == null || storage["Addintegral5"] == ""){
							$.ajax({
						...
						var  Addintegral5 =  "Addintegral5";
		    	    	 storage["Addintegral5"] = Addintegral5;
	         ...
	         if(Knowledge_Name == "药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral6"] == null || storage["Addintegral6"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral6 =  "Addintegral6";
		    	    	storage["Addintegral6"] = Addintegral6;
		    	    	$("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    	     }
	         ...
	         if(Knowledge_Name == "药学综合知识与技能" ){
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral7"] == null || storage["Addintegral7"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral7 =  "Addintegral7";
		    	    	 storage["Addintegral7"] = Addintegral7;
		    	    	 $("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    	     }
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage == 100){
	    	    	   if(storage["Addintegral8"] == null || storage["Addintegral8"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral8 =  "Addintegral8";
		    	    	 storage["Addintegral8"] = Addintegral8;
		    	    	 $("#sr-only").text("本次练习获得了满分,一定要坚持啊!");
	    	       }
	    		  };
	     }
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     var  lv2state = $(".lv2state").text();//礼物领取状态
					  		     var  lv3state = $(".lv3state").text();//礼物领取状态
								window.location.href="../West/West?subjectsid="+subjectsid+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&days="+days+"&dateTime="+dateTime+"&integral="+integral+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
