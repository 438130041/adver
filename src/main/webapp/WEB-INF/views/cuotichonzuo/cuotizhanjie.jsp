...
<script type="text/javascript">
	...
	function switchs(){//切换科目（回到科目选择页面）
			/* alert("微信id："+openid); *///
			window.location.href="../cuotikemuzhangjie/switch?openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"";
	}
