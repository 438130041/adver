  ...
  <div class="modal-dialog" role="document">
  	 	...
  	 	$(function(){
  		    ...
  		    var  knowledge_Id = $(".knowledge_Id").text();//该章节题目id
  	 	    ...
  	 	    /* alert("缓存的时间："+storagedateTime["storagedateTime"]);  */
  	 		 if(storagedateTime["cuotistoragedateTime"] != dateTime){
  	 			...
  	 			locationcolor.removeItem(cuotique5int_second5);//将之前的做题记录设置为空
  	 			locationcolor.removeItem(cuotique6int_second6);
  	 			locationcolor.removeItem(cuotique7int_second7);
  	 			locationcolor.removeItem(cuotique8int_second8);
  	 			//删除正确率获积分记录
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     storage5["cuotique5Knowledge_Name5"] = Knowledge_Name;
	    	     storage5["cuotique5fractionPe5"] = fractionPe;
	    	     storage5["cuotique5percentage5"] = percentage;
	    	     storage5["cuotique5correctnumber5"] = correctnumber;
	    	     storage5["cuotique5int_second5"] = int_second;
	    	     storage5["cuotique5queanswer5"] = queanswer;
	    	     storage5["cuotique5answers5"] = answers;
	    	     storage5["cuotique5andays5"] = dayss;
	    	     storage5["cuotique5integral5"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["cuotiAddintegral5"] == null || storage["cuotiAddintegral5"] == ""){
							$.ajax({
						...
						var  Addintegral5 =  "cuotiAddintegral5";
		    	    	 storage["cuotiAddintegral5"] = Addintegral5;
	         ...
	         if(Knowledge_Name == "药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     storage6["cuotique6Knowledge_Name6"] = Knowledge_Name;
	    	     storage6["cuotique6fractionPe6"] = fractionPe;
	    	     storage6["cuotique6percentage6"] = percentage;
	    	     storage6["cuotique6correctnumber6"] = correctnumber;
	    	     storage6["cuotique6int_second6"] = int_second;
	    	     storage6["cuotique6queanswer6"] = queanswer;
	    	     storage6["cuotique6answers6"] = answers;
	    	     storage6["cuotique6andays6"] = dayss;
	    	     storage6["cuotique6integral6"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["cuotiAddintegral6"] == null || storage["cuotiAddintegral6"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral6 =  "cuotiAddintegral6";
		    	    	storage["cuotiAddintegral6"] = Addintegral6;
	         ...
	         if(Knowledge_Name == "药学综合知识与技能" ){
	    	     ...
	    	     storage7["cuotique7Knowledge_Name7"] = Knowledge_Name;
	    	     storage7["cuotique7fractionPe7"] = fractionPe;
	    	     storage7["cuotique7percentage7"] = percentage;
	    	     storage7["cuotique7correctnumber7"] = correctnumber;
	    	     storage7["cuotique7int_second7"] = int_second;
	    	     storage7["cuotique7queanswer7"] = queanswer;
	    	     storage7["cuotique7answers7"] = answers;
	    	     storage7["cuotique7andays7"] = dayss;
	    	     storage7["cuotique7integral7"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["cuotiAddintegral7"] == null || storage["cuotiAddintegral7"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral7 =  "cuotiAddintegral7";
		    	    	 storage["cuotiAddintegral7"] = Addintegral7;
	    	...
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  storage8["cuotique8Knowledge_Name8"] = Knowledge_Name;
	        	  storage8["cuotique8fractionPe8"] = fractionPe;
	        	  storage8["cuotique8percentage8"] = percentage;
	        	  storage8["cuotique8correctnumber8"] = correctnumber;
	        	  storage8["cuotique8int_second8"] = int_second;
	        	  storage8["cuotique8queanswer8"] = queanswer;
	        	  storage8["cuotique8answers8"] = answers;
	        	  storage8["cuotique8andays8"] = dayss;
	        	  storage8["cuotique8integral8"] = integral;
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["cuotiAddintegral8"] == null || storage["cuotiAddintegral8"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral8 =  "cuotiAddintegral8";
		    	    	 storage["cuotiAddintegral8"] = Addintegral8;
    ...
    function jiexis(Knowledge_Names){
    	...
    	alert("点击的题型："+Knowledge_Name); */
    	 if("药学专业知识一" == Knowledge_Names){
	    	/* alert("已经进入中药学专业知识一"); */
		     ...
		     if(!storage5["cuotique5int_second5"] ||  storage5["cuotique5int_second5"] == 0){
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     var YXY = "YXY";
					  			 var  kemuZYHXY = "西药";
					  		     window.location.href="../cuotikemuzhangjie/cuotikemuzhangjie?kemu="+YXY+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
							    ...
							    /*  var dateTime = $(".dateTime").text(); */
							     ...
							     storage5["cuotique5queanswer5"] = queanswer;
							     storage5["cuotique5answers5"] = answers;
							     storage5["cuotique5andays5"] = days;
							     storage5["cuotique5integral5"] = integral;
		     ...
		     if(storage5["cuotique5int_second5"] &&  storage5["cuotique5int_second5"] != 0){
		    	 ...
		    	 var getKnowledge_Name = storage5["cuotique5Knowledge_Name5"];
		    	 var getfractionPe = storage5["cuotique5fractionPe5"];
		    	 var getpercentage = storage5["cuotique5percentage5"];
		    	 var getcorrectnumber = storage5["cuotique5correctnumber5"];
		    	 var getint_second = storage5["cuotique5int_second5"];
		    	 var getqueanswer = storage5["cuotique5queanswer5"];
		    	 var getanswers = storage5["cuotique5answers5"];
		    	 var getdays = storage5["cuotique5andays5"];
		    	 var getintegral  = storage5["cuotique5integral5"];
     ...
     if("药学专业知识二" == Knowledge_Names){
	     ...
	     var storage6 = window.localStorage;
	     if(!storage6["cuotique6int_second6"] || storage6["cuotique6int_second6"] == 0 ){
					popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){
						  //callback 处理按钮事件
						  var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../cuotikemuzhangjie/cuotikemuzhangjie?kemu="+YXE+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
								 if($(".Knowledge_Name").text() == "药学专业知识二"){
								    ...
								    /*  var dateTime = $(".dateTime").text(); */
								     ...
								     storage6["cuotique6queanswer6"] = queanswer;
								     storage6["cuotique6answers6"] = answers;
								     storage6["cuotique6andays6"] = days;
								     storage6["cuotique6integral6"] = integral;
								     /* storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
	     ...
	     if(storage6["cuotique6int_second6"] &&  storage6["cuotique6int_second6"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage6["cuotique6Knowledge_Name6"];
	    	 var getfractionPe = storage6["cuotique6fractionPe6"];
	    	 var getpercentage = storage6["cuotique6percentage6"];
	    	 var getcorrectnumber = storage6["cuotique6correctnumber6"];
	    	 var getint_second = storage6["cuotique6int_second6"];
	    	 var getqueanswer = storage6["cuotique6queanswer6"];
	    	 var getanswers = storage6["cuotique6answers6"]
	    	 var getdays = storage6["cuotique6andays6"];
	    	 var getintegral = storage6["cuotique6integral6"];
	    	 var getdateTime = storagedateTime["cuotistoragedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","block");
     ...
     if("药学综合知识与技能" == Knowledge_Names){
    	 //设置localStorage用于页面的本地储存(将数据存入storage中去)
	     var storage7 = window.localStorage;
	     if(!storage7["cuotique7int_second7"] || storage7["cuotique7int_second7"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
							...
							setTimeout(function() {
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../cuotikemuzhangjie/cuotikemuzhangjie?kemu="+YXZH+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
								if($(".Knowledge_Name").text() == "药学综合知识与技能"){
							     ...
							     storage7["cuotique7queanswer7"] = queanswer;
							     storage7["cuotique7answers7"] = answers;
							     storage7["cuotique7andays7"] = days;
							     storage7["cuotique7integral7"] = integral;
							    /*  storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
							     $("#active1").css("display","none");
							     $("#active2").css("display","none");
	     ...
	     if(storage7["cuotique7int_second7"] &&  storage7["cuotique7int_second7"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage7["cuotique7Knowledge_Name7"];
	    	 var getfractionPe = storage7["cuotique7fractionPe7"];
	    	 var getpercentage = storage7["cuotique7percentage7"];
	    	 var getcorrectnumber = storage7["cuotique7correctnumber7"];
	    	 var getint_second = storage7["cuotique7int_second7"];
	    	 var getqueanswer = storage7["cuotique7queanswer7"];
	    	 var getanswers = storage7["cuotique7answers7"];
	    	 var getdays = storage7["cuotique7andays7"];
	    	 var getintegral = storage7["cuotique7integral7"] ;
	         var getdateTime = storagedateTime["cuotistoragedateTime"]; 
	         $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
     ...
     if("药事管理与法规" == Knowledge_Names){
    	 var storage8 = window.localStorage;
	     if(!storage8["cuotique8int_second8"] || storage8["cuotique8int_second8"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
						  if(button == 'ok'){ 
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
							     ...
							     storage8["cuotique8queanswer8"] = queanswer;
							     storage8["cuotique8answers8"] = answers;
							     storage8["cuotique8andays8"] = days;
							     storage8["cuotique8integral8"] = integral;
							     /* storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
							     $("#active1").css("display","none");
							     $("#active2").css("display","none");
	     ...
	     if(storage8["cuotique8int_second8"] &&  storage8["cuotique8int_second8"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage8["cuotique8Knowledge_Name8"];
	    	 var getfractionPe = storage8["cuotique8fractionPe8"];
	    	 var getpercentage = storage8["cuotique8percentage8"];
	    	 var getcorrectnumber = storage8["cuotique8correctnumber8"];
	    	 var getint_second = storage8["cuotique8int_second8"];
	    	 var getqueanswer = storage8["cuotique8queanswer8"];
	    	 var getanswers = storage8["cuotique8answers8"];
	    	 var getdays = storage8["cuotique8andays8"];
	    	 var getintegral = storage8["cuotique8integral8"] ;
	    	 var getdateTime = storagedateTime["cuotistoragedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
	  ...
	  var  lv3state = $(".lv3state").text();//礼物领取状态
      var storagedateTime = window.localStorage;
      var dateTime = storagedateTime["cuotistoragedateTime"];//当前登录时间
      //查看排行榜(排行榜点击事件)
      function ranking(){
    ...
    //在做一次
      function  again(){
    	 ...
    	 /*  alert("题目名："+kemuZYHXY); */
    	  window.location.href="../cuotikemuzhangjie/practice?knowledge_Id="+knowledge_Id+"&kemu="+kemu+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&kemuZYHXY="+kemuZYHXY+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
    	 /*  window.location.href="../jinxuantiaging/aging?Knowledge_Name="+Knowledge_Name+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&names="+names+"&days="+dayss+"&dateTime="+dateTime+"&integral="+integrals+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"&knowledge_Id="+knowledge_Id+"&kemuZYHXY="+kemuZYHXY+"";   */  
      }  
    //题目解析
      function  jiexi(){
    	  var  Knowledge_Name  =  $(".Knowledge_Name").text();//题型名
							  ...
							  if(button == 'ok'){
								...
								setTimeout(function(){
									 $("#lw3").css("background-color","#C0C0C0");
						  		    	...
						  		    	var storage7 = window.localStorage;
						  		    	var storage8 = window.localStorage;
						  		    	storage5["cuotique5integral5"] = data.integral;
						  		    	storage6["cuotique6integral6"] = data.integral;
						  		    	storage7["cuotique7integral7"] = data.integral;
						  		    	storage8["cuotique8integral8"] = data.integral;
