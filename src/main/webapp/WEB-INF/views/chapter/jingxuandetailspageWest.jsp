  ...
  <div class="modal-dialog" role="document">
     ...
     <script  type="text/javascript">
  	 	...
  	 	//缓存当前时间
  	 	    ...
  	 	    /* alert("缓存的时间："+storagedateTime["storagedateTime"]);  */
  	 		 if(storagedateTime["storagedateTime"] != dateTime   &&  storagedateTime["storagedateTime"] != null){
  	 			...
  	 			locationcolor.removeItem(que5int_second5);//将之前的做题记录设置为空
  	 			locationcolor.removeItem(que6int_second6);
  	 			locationcolor.removeItem(que7int_second7);
  	 			locationcolor.removeItem(que8int_second8);
  	 		//删除正确率获积分记录
  	 			locationcolor.removeItem(jingxuangAddintegral5);
  	 		 	locationcolor.removeItem(jingxuangAddintegral6);
  	 		 	locationcolor.removeItem(jingxuangAddintegral7);
  	 			locationcolor.removeItem(jingxuangAddintegral8);
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     storage5["que5Knowledge_Name5"] = Knowledge_Name;
	    	     storage5["que5fractionPe5"] = fractionPe;
	    	     storage5["que5percentage5"] = percentage;
	    	     storage5["que5correctnumber5"] = correctnumber;
	    	     storage5["que5int_second5"] = int_second;
	    	     storage5["que5queanswer5"] = queanswer;
	    	     storage5["que5answers5"] = answers;
	    	     storage5["que5andays5"] = dayss;
	    	     storage5["que5integral5"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){//
	    	    	   if(storage["jingxuangAddintegral5"] == null || storage["jingxuangAddintegral5"] == ""){
							$.ajax({
						...
						var  Addintegral5 =  "jingxuangAddintegral5";
		    	    	 storage["jingxuangAddintegral5"] = Addintegral5;
	         ...
	         if(Knowledge_Name == "药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     storage6["que6Knowledge_Name6"] = Knowledge_Name;
	    	     storage6["que6fractionPe6"] = fractionPe;
	    	     storage6["que6percentage6"] = percentage;
	    	     storage6["que6correctnumber6"] = correctnumber;
	    	     storage6["que6int_second6"] = int_second;
	    	     storage6["que6queanswer6"] = queanswer;
	    	     storage6["que6answers6"] = answers;
	    	     storage6["que6andays6"] = dayss;
	    	     storage6["que6integral6"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["jingxuangAddintegral6"] == null || storage["jingxuangAddintegral6"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral6 =  "jingxuangAddintegral6";
		    	    	storage["jingxuangAddintegral6"] = Addintegral6;
	         ...
	         if(Knowledge_Name == "药学综合知识与技能" ){
	    	     ...
	    	     storage7["que7Knowledge_Name7"] = Knowledge_Name;
	    	     storage7["que7fractionPe7"] = fractionPe;
	    	     storage7["que7percentage7"] = percentage;
	    	     storage7["que7correctnumber7"] = correctnumber;
	    	     storage7["que7int_second7"] = int_second;
	    	     storage7["que7queanswer7"] = queanswer;
	    	     storage7["que7answers7"] = answers;
	    	     storage7["que7andays7"] = dayss;
	    	     storage7["que7integral7"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["jingxuangAddintegral7"] == null || storage["jingxuangAddintegral7"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral7 =  "jingxuangAddintegral7";
		    	    	 storage["jingxuangAddintegral7"] = Addintegral7;
	    	...
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  storage8["que8Knowledge_Name8"] = Knowledge_Name;
	        	  storage8["que8fractionPe8"] = fractionPe;
	        	  storage8["que8percentage8"] = percentage;
	        	  storage8["que8correctnumber8"] = correctnumber;
	        	  storage8["que8int_second8"] = int_second;
	        	  storage8["que8queanswer8"] = queanswer;
	        	  storage8["que8answers8"] = answers;
	        	  storage8["que8andays8"] = dayss;
	        	  storage8["que8integral8"] = integral;
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["jingxuangAddintegral8"] == null || storage["jingxuangAddintegral8"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral8 =  "jingxuangAddintegral8";
		    	    	 storage["jingxuangAddintegral8"] = Addintegral8;
    ...
    function jiexis(Knowledge_Names){
    	...
    	alert("点击的题型："+Knowledge_Name); */
    	 if("药学专业知识一" == Knowledge_Names){
	    	/* alert("已经进入中药学专业知识一"); */
		     ...
		     if(!storage5["que5int_second5"] ||  storage5["que5int_second5"] == 0){
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     var YXY = "YXY";
					  			 var  kemuZYHXY = "西药";
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+YXY+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
		     ...
		     if(storage5["que5int_second5"] &&  storage5["que5int_second5"] != 0){
		    	 ...
		    	 var getKnowledge_Name = storage5["que5Knowledge_Name5"];
		    	 var getfractionPe = storage5["que5fractionPe5"];
		    	 var getpercentage = storage5["que5percentage5"];
		    	 var getcorrectnumber = storage5["que5correctnumber5"];
		    	 var getint_second = storage5["que5int_second5"];
		    	 var getqueanswer = storage5["que5queanswer5"];
		    	 var getanswers = storage5["que5answers5"];
		    	 var getdays = storage5["que5andays5"];
		    	 var getintegral  = storage5["que5integral5"];
     ...
     if("药学专业知识二" == Knowledge_Names){
	     ...
	     var storage6 = window.localStorage;
	     if(!storage6["que6int_second6"] || storage6["que6int_second6"] == 0 ){
					popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						  var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+YXE+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
	     ...
	     if(storage6["que6int_second6"] &&  storage6["que6int_second6"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage6["que6Knowledge_Name6"];
	    	 var getfractionPe = storage6["que6fractionPe6"];
	    	 var getpercentage = storage6["que6percentage6"];
	    	 var getcorrectnumber = storage6["que6correctnumber6"];
	    	 var getint_second = storage6["que6int_second6"];
	    	 var getqueanswer = storage6["que6queanswer6"];
	    	 var getanswers = storage6["que6answers6"]
	    	 var getdays = storage6["que6andays6"];
	    	 var getintegral = storage6["que6integral6"];
	    	 var getdateTime = storagedateTime["storagedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","block");
     ...
     if("药学综合知识与技能" == Knowledge_Names){
    	 //设置localStorage用于页面的本地储存(将数据存入storage中去)
	     var storage7 = window.localStorage;
	     if(!storage7["que7int_second7"] || storage7["que7int_second7"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
							...
							setTimeout(function() {
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+YXZH+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
	     ...
	     if(storage7["que7int_second7"] &&  storage7["que7int_second7"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage7["que7Knowledge_Name7"];
	    	 var getfractionPe = storage7["que7fractionPe7"];
	    	 var getpercentage = storage7["que7percentage7"];
	    	 var getcorrectnumber = storage7["que7correctnumber7"];
	    	 var getint_second = storage7["que7int_second7"];
	    	 var getqueanswer = storage7["que7queanswer7"];
	    	 var getanswers = storage7["que7answers7"];
	    	 var getdays = storage7["que7andays7"];
	    	 var getintegral = storage7["que7integral7"] ;
	         var getdateTime = storagedateTime["storagedateTime"]; 
	         $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
     ...
     if("药事管理与法规" == Knowledge_Names){
    	 var storage8 = window.localStorage;
	     if(!storage8["que8int_second8"] || storage8["que8int_second8"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
	     ...
	     if(storage8["que8int_second8"] &&  storage8["que8int_second8"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage8["que8Knowledge_Name8"];
	    	 var getfractionPe = storage8["que8fractionPe8"];
	    	 var getpercentage = storage8["que8percentage8"];
	    	 var getcorrectnumber = storage8["que8correctnumber8"];
	    	 var getint_second = storage8["que8int_second8"];
	    	 var getqueanswer = storage8["que8queanswer8"];
	    	 var getanswers = storage8["que8answers8"];
	    	 var getdays = storage8["que8andays8"];
	    	 var getintegral = storage8["que8integral8"] ;
	    	 var getdateTime = storagedateTime["storagedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
	  ...
	  var  lv3state = $(".lv3state").text();//礼物领取状态
      var storagedateTime = window.localStorage;
      var dateTime = storagedateTime["storagedateTime"];//当前登录时间
      //查看排行榜(排行榜点击事件)
      function ranking(){
							  ...
							  if(button == 'ok'){
								...
								setTimeout(function(){
									 $("#lw3").css("background-color","#C0C0C0");
						  		    	...
						  		    	var storage7 = window.localStorage;
						  		    	var storage8 = window.localStorage;
						  		    	storage5["que5integral5"] = data.integral;
						  		    	storage6["que6integral6"] = data.integral;
						  		    	storage7["que7integral7"] = data.integral;
						  		    	storage8["que8integral8"] = data.integral;
