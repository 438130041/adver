...
<script  type="text/javascript">
  	 	...
  	 	$(function(){
  	 		...
  	 		console.log("中药题用户选择的答案："+storagexuanxian["queanswer"+knowledge_Id]);
  	 		console.log("中药题正确的答案："+storagexuanxian["answers"+knowledge_Id]);
  	 		console.log("时间："+storagedateTime["storagedateTime"]); 
  	 		var dateTime = $(".dateTime").text();//当前登录时间
  	 		/*  alert("缓存的时间："+storagedateTime["storagedateTime"]);  */
  	 		if(storagedateTime["storagedateTime"] != dateTime){//如果缓存里的时间与当前做题时间不一样，说明不是同一天。第一次进入的用户时间缓存是空的，所有判断也会成立
  	 			 /*  alert("不相等进入"); */
  	 			/* window.localStorage.clear(); *///清空所有缓存（进入此页面说明已经交卷了，可以删除之前的所有做题数据了）
  	 			locationcolor.removeItem(que1int_second1);//将之前的做题记录设置为空
  	 			locationcolor.removeItem(que2int_second2);
  	 			locationcolor.removeItem(que3int_second3);
  	 			locationcolor.removeItem(que4int_second4);
  	 		//删除正确率获积分记录
  	 			locationcolor.removeItem(jingxuangAddintegral1);
  	 		 	locationcolor.removeItem(jingxuangAddintegral2);
  	 		 	locationcolor.removeItem(jingxuangAddintegral3);
  	 			locationcolor.removeItem(jingxuangAddintegral4);
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "中药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     storage1["que1Knowledge_Name1"] = Knowledge_Name;
	    	     storage1["que1fractionPe1"] = fractionPe;
	    	     storage1["que1percentage1"] = percentage;
	    	     storage1["que1correctnumber1"] = correctnumber;
	    	     storage1["que1int_second1"] = int_second;
	    	     storage1["que1queanswer1"] = queanswer;
	    	     storage1["que1answers1"] = answers;
	    	     storage1["que1andays1"] = dayss;
	    	     storage1["que1integral1"] = integral;
	    	     $("#active1").css("display","block");
	    	       ...
	    	       if(percentage >= 50){
						if(storage["jingxuangAddintegral1"] == null || storage["jingxuangAddintegral"] == ""){
							$.ajax({
						...
						var  Addintegral1 =  "jingxuangAddintegral1";
		    	    	storage["jingxuangAddintegral1"] = Addintegral1;
	    	       }
	    	       if(percentage == 100){
	         ...
	         if(Knowledge_Name == "中药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     storage2["que2Knowledge_Name2"] = Knowledge_Name;
	    	     storage2["que2fractionPe2"] = fractionPe;
	    	     storage2["que2percentage2"] = percentage;
	    	     storage2["que2correctnumber2"] = correctnumber;
	    	     storage2["que2int_second2"] = int_second;
	    	     storage2["que2queanswer2"] = queanswer;
	    	     storage2["que2answers2"] = answers;
	    	     storage2["que2andays2"] = dayss;
	    	     storage2["que2integral2"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["jingxuangAddintegral2"] == null || storage["jingxuangAddintegral2"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral2 =  "jingxuangAddintegral2";
		    	       storage["jingxuangAddintegral2"] = Addintegral2;
	         ...
	         if(Knowledge_Name == "中药学综合知识与技能" ){
	    	     ...
	    	     storage3["que3Knowledge_Name3"] = Knowledge_Name;
	    	     storage3["que3fractionPe3"] = fractionPe;
	    	     storage3["que3percentage3"] = percentage;
	    	     storage3["que3correctnumber3"] = correctnumber;
	    	     storage3["que3int_second3"] = int_second;
	    	     storage3["que3queanswer3"] = queanswer;
	    	     storage3["que3answers3"] = answers;
	    	     storage3["que3andays3"] = dayss;
	    	     storage3["que3integral3"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["jingxuangAddintegral3"] == null || storage["jingxuangAddintegral3"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral3 =  "jingxuangAddintegral3";
	    	    	   storage3["jingxuangAddintegral3"] = Addintegral3;
	    	...
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  storage4["que4Knowledge_Name4"] = Knowledge_Name;
	        	  storage4["que4fractionPe4"] = fractionPe;
	        	  storage4["que4percentage4"] = percentage;
	        	  storage4["que4correctnumber4"] = correctnumber;
	        	  storage4["que4int_second4"] = int_second;
	        	  storage4["que4queanswer4"] = queanswer;
	        	  storage4["que4answers4"] = answers;
	        	  storage4["que4andays4"] = dayss;
	        	  storage4["que4integral4"] = integral;
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage >=  50){
	    	    	   if(storage["jingxuangAddintegral4"] == null || storage["jingxuangAddintegral4"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
	    	    	   ...
	    	    	   var  Addintegral4 =  "jingxuangAddintegral4";
	    	    	   storage["jingxuangAddintegral4"] = Addintegral4;
    ...
    function jiexis(Knowledge_Names){
    	...
    	alert("点击的题型："+Knowledge_Name); */
    	 if("中药学专业知识一" == Knowledge_Names){
	    	/* alert("已经进入中药学专业知识一"); */
		     ...
		     if(!storage1["que1int_second1"] ||  storage1["que1int_second1"] == 0){
								...
								/*  webToast("操作成功","top", 2000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     var  lv3state = $(".lv3state").text();//礼物领取状态
					  		      var ZYY = "ZYY";
					  			  var  kemuZYHXY = "中药";
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+ZYY+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
		     ...
		     if(storage1["que1int_second1"] &&  storage1["que1int_second1"] != 0){
		    	 ...
		    	 var getKnowledge_Name = storage1["que1Knowledge_Name1"];
		    	 var getfractionPe = storage1["que1fractionPe1"];
		    	 var getpercentage = storage1["que1percentage1"];
		    	 var getcorrectnumber = storage1["que1correctnumber1"];
		    	 var getint_second = storage1["que1int_second1"];
		    	 var getqueanswer = storage1["que1queanswer1"];
		    	 var getanswers = storage1["que1answers1"];
		    	 var getdays = storage1["que1andays1"];
		    	 var getintegral  = storage1["que1integral1"];
		    	 var getdateTime = storagedateTime["storagedateTime"]; 
		    	 $("#active1").css("display","block");
			     $("#active2").css("display","none");
			     $("#active3").css("display","none");
			     $("#active4").css("display","none");
     ...
     if("中药学专业知识二" == Knowledge_Names){
	     ...
	     var storage2 = window.localStorage;
	     if(!storage2["que2int_second2"] || storage2["que2int_second2"] == 0 ){
					popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						  var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 2000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+ZYE+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
	     ...
	     if(storage2["que2int_second2"] &&  storage2["que2int_second2"] != 0){
	    		var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage2["que2Knowledge_Name2"];
	    	 var getfractionPe = storage2["que2fractionPe2"];
	    	 var getpercentage = storage2["que2percentage2"];
	    	 var getcorrectnumber = storage2["que2correctnumber2"];
	    	 var getint_second = storage2["que2int_second2"];
	    	 var getqueanswer = storage2["que2queanswer2"];
	    	 var getanswers = storage2["que2answers2"] 
	    	 var getdays = storage2["que2andays2"];
	    	 var getintegral = storage2["que2integral2"];
	    	 var gerdateTime = storagedateTime["storagedateTime"]; 
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","block");
		     $("#active3").css("display","none");
		     $("#active4").css("display","none");
     ...
     if("中药学综合知识与技能" == Knowledge_Names){
    	 //设置localStorage用于页面的本地储存(将数据存入storage中去)
	     var storage3 = window.localStorage;
	     if(!storage3["que3int_second3"] || storage3["que3int_second3"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 2000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+ZYZH+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
	     ...
	     if(storage3["que3int_second3"] &&  storage3["que3int_second3"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage3["que3Knowledge_Name3"];
	    	 var getfractionPe = storage3["que3fractionPe3"];
	    	 var getpercentage = storage3["que3percentage3"];
	    	 var getcorrectnumber = storage3["que3correctnumber3"];
	    	 var getint_second = storage3["que3int_second3"];
	    	 var getqueanswer = storage3["que3queanswer3"];
	    	 var getanswers = storage3["que3answers3"];
	    	 var getdays = storage3["que3andays3"];
	    	 var getintegral = storage3["que3integral3"];
	    	 var getdateTime =  storagedateTime["storagedateTime"];
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
		     $("#active3").css("display","block");
     ...
     if("药事管理与法规" == Knowledge_Names){
    	 var storage4 = window.localStorage;
	     if(!storage4["que4int_second4"] || storage4["que4int_second4"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 2000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     var  YS = "YS";
					  			 var  kemuZYHXY = "中药";
					  		     window.location.href="../kemuxuanze/kemuxuanze?kemu="+YS+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
	     ...
	     if(storage4["que4int_second4"] &&  storage4["que4int_second4"] != 0){
	    		var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage4["que4Knowledge_Name4"];
	    	 var getfractionPe = storage4["que4fractionPe4"];
	    	 var getpercentage = storage4["que4percentage4"];
	    	 var getcorrectnumber = storage4["que4correctnumber4"];
	    	 var getint_second = storage4["que4int_second4"];
	    	 var getqueanswer = storage4["que4queanswer4"];
	    	 var getanswers = storage4["que4answers4"];
	    	 var getdays = storage4["que4andays4"];
	    	 var getintegral = storage4["que4integral4"] ;
	    	var getdateTime = storagedateTime["storagedateTime"];
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
		     $("#active3").css("display","none");
      ...
      //中药学综合知识与技能
       ...
       $('.FG').on('click', function(){
		 ...
		 var  lv3state = $(".lv3state").text();//礼物领取状态
         var storagedateTime = window.localStorage;
         var dateTime = storagedateTime["storagedateTime"];
      //查看排行榜(排行榜点击事件)
      function ranking(){
     ...
     //题目解析
      function  jiexi(){
    	  ...
    	  /* alert("kemuZYHXY："+kemuZYHXY); */
     	  window.location.href="../jingxuanjiexi/jiexi?correctnumber="+correctnumber+"&percentage="+percentage+"&int_second="+int_second+"&Knowledge_Name="+Knowledge_Name+"&nickname="+nickname+"&openid="+openid+"&headimgurl="+headimgurl+"&tixing="+tixing+"&days="+dayss+"&dateTime="+dateTime+"&integral="+integrals+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+"&knowledge_Id="+knowledge_Id+"&datalength="+datalength+"&kemuZYHXY="+kemuZYHXY+"";   
    	}  
							  ...
							  if(button == 'ok'){
								...
								setTimeout(function(){
									$("#lw3").css("background-color","#C0C0C0");
					  		    	...
					  		    	var storage3 = window.localStorage;
					  		    	var storage4 = window.localStorage;
					  		    	storage1["que1integral1"] = data.integral;
					  		    	storage2["que2integral2"] = data.integral;
					  		    	storage3["que3integral3"] = data.integral;
					  		    	storage4["que4integral4"] = data.integral;
