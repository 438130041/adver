...
<div class="panel-heading">
    ...
    <div>
        <img src="../resources/admin/login/img/logo.png" style="width: 100%">
    </div>
</div>
<div class="panel-body">
   	<div class="tishi">注册用户信息</div>
   <div class="col-xs-12  ">
       <div class="form-group">
           <input  class="form-control"  id="name" name="User_Name"  type="text" placeholder="请填写真实姓名">
       </div>
   </div>
   ...
   <div class="col-xs-12" style="text-align:center;">
       <input id="btnres"  style="width: 100%" class="btn btn-primary" type="button" value="注册" onclick="Link()">
   </div>
</div> 
</body>
