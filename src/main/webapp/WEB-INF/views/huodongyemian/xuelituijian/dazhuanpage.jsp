...
<%--</div>--%>
<div class="middle">
    <img src="../resources/admin/login/huodongimg/eer.jpg" alt="" style="width: 100%;height: 100%">
</div>

<div class="panel-body">
    <div class="col-xs-12" style="text-align:center;">
        <input id="btnr"  style="width: 100% ;height: 6%;font-size: 140%;border-radius: 50px;" class="btn btn-primary" type="button" value="进群咨询" onclick="ming()">
    </div>
