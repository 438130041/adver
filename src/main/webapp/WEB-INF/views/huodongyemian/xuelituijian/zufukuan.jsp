...
<div>
<div>
    <img src="../resources/admin/login/huodongimg/r.png" alt="" style="width: 100%">
</div>
    ...
    <br>
    <div class="pay_area">
        <p class="prices" style="padding-right:25px;"> 定金:
            <strong class="font">￥200.0元</strong>
        </p>
    </div>
</div>
<br>
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.type=="su") {
                    ...
                    window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxbf8bce0d4f7e3ae3&redirect_uri=http://shop.jingyaoshi.net/wxunifiedOrder&response_type=code&scope=snsapi_userinfo&state="+data.oo+"#wechat_redirect";
                }
            }
