                      ...
                      <dl class="layui-nav-child">
                      	<dd>
                      		...
                      		<ol class="layui-nav-child" style="display: none;">
                      			...
                      			<li><a href="../yiyuehotai/cenjiaoxinxi"><i class="fa fa-calendar"></i><span class="layui-left-nav">&nbsp;&nbsp;&nbsp;&nbsp;成交信息</span></a></li></li>
                      		</ol>
                      	</dd>
                      </dl>
                </li>
...
<script>
    layui.use(['table'], function() {
        ...
        table.render({
             elem: '#productDemo'
            , url: '../jianpinzhuantai/jianpinzhuantai'
            , id: 'productReload'
            , page: true
