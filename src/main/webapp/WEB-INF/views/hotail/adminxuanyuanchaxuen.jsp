    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="demoTable">
                ...
                <!-- 老师代码 -->
                <div class="layui-input-inline" style="margin-top:10px;">
                    <input type="text" name="TeacherCodes" id="TeacherCodes" required lay-verify="required" class="layui-input" placeholder="请输入专属代码">
                </div>
                <button class="layui-btn" style="margin-top:10px;" data-type="reloadTeacherCodes" id="sousuoTeacherCodes">
                    <i class="layui-icon">&#xe615;</i>搜索
                </button>
...
<script>
    layui.use(['table'], function() {
        ...
        table.render({
            elem: '#productDemo'
            , url: '../zhuanshuxueyuan/zhuanshuxueyuanpost'
            , id: 'productReload'
            , page: true
            ...
            , cols: [[
                ...
                , {field: 'dakatishu', title: '连续打卡天数'}
                , {field: 'dakatime', title: '打卡时间'}
                , {field: 'integral', title: '累计积分'}
                , {field: 'TeacherCodes', title: '老师代码'}
        ...
        //根据用户代码查询学员信息
        $('#sousuoTeacherCodes').on('click', function () {
            var type = $(this).data('type');
             console.log("代码type:"+type); 
            active[type] ? active[type].call(this) : '';
        });
