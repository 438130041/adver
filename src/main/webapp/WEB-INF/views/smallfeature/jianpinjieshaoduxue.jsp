...
<body>
	...
	<div class="feizhenshixueyuan">feizhenshixueyuan</div>
	<div class="huodonjiesao">
		<img alt="" src=""   id="imgs">
		  <div  class="buttondiv">
			<button type="button" class="btn btn-primary btn-lg"   id="canjia">立即进入比赛</button>
		  </div>	
	</div>
...
<script type="text/javascript">
		 $(function(){
			...
			if(codes == "101" || codes == "102" || codes == "103" || codes == "104" || codes == "105" || codes == "106"  || codes ==  "107" || codes == "108"
				...
				$("#imgs").attr("src","../resources/admin/login/img/huodongjishao.png");
			}else {
				$(".buttondiv").addClass("buttondivyinye");
				$("#imgs").attr("src","../resources/admin/login/img/yinyehuodongjishao.png");
			}
		}) 
		...
		$("#canjia").click(function(){
			...
			window.location.href="../paihanban/paihanban?openid="+openid+"&feizhenshixueyuan="+feizhenshixueyuan+"";
		})
