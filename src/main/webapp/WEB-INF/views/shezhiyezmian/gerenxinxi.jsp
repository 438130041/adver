...
<body>
    ...
    <div class="fanhui">
    	<div  class="text"><img alt="" src="../resources/admin/login/img/xiangzuo.png" id="imgs"  onclick="fanhui()">个人信息</div>
    </div>	
	<div class="container">
        <div class="classification">
            <div class="classification-1">
                <ul class="firstli">
                    <li>
                        <div class="arraytoxian">
                        	<div class="texttoxian">头像</div>
                        	<div class="toxianimg">
                        		<img alt="" src="" id="toxianimg"> 
                        	</div> 
                        </div>
                    </li>
                    <li>
                        <div class="array"> 
                        	<div class="textlishi">昵称</div>
                        	<div class="lishiimg">
                   ...
                   <!--  <li>
                        <div class="array">
                        	<div class="textbanzhu">帮助中心</div>
                        	<div class="bangzhuimg">
...
<script type="text/javascript">
	...
	function fanhui(){
		 var  openid  = $(".openid"). text(); 
		 window.location.href="../tiaozhuankonzhi/xinxiyefanhui?openid="+openid+"";
