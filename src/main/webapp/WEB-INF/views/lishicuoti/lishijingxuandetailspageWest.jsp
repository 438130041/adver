  ...
  <div class="modal-dialog" role="document">
     ...
     <script  type="text/javascript">
  	 	...
  	 	//缓存当前时间
  	 	    ...
  	 	    /* alert("缓存的时间："+storagedateTime["storagedateTime"]);  */
  	 		 if(storagedateTime["lishistoragedateTime"] != dateTime){
  	 			/* alert("进入删除"); */
  	 			...
  	 			locationcolor.removeItem(lishique5int_second5);//将之前的做题记录设置为空
  	 			locationcolor.removeItem(lishique6int_second6);
  	 			locationcolor.removeItem(lishique7int_second7);
  	 			locationcolor.removeItem(lishique8int_second8);
  	 		//删除正确率获积分记录
  	 	...
  	 	//做完题目进入页面 
  		    var  knowledge_Id = $(".knowledge_Id").text();//该章节题目id
  	 		...
  	 		console.log("章节id："+knowledge_Id);
  	 		 console.log("正确选择："+storagexuanxian["lishianswers"+knowledge_Id]);
	 		console.log("用户选择的答案："+storagexuanxian["lishiqueanswer"+knowledge_Id]);
	     ...
	     function obtain(Knowledge_Name,fractionPe,percentage,correctnumber,int_second,queanswer,answers,dayss,integral,openid){
  	 		...
  	 		if(Knowledge_Name == "药学专业知识一" ){
	        	...
	        	/*  alert("将数据进行缓存："+fractionPe);   */
	    	     ...
	    	     storage5["lishique5Knowledge_Name5"] = Knowledge_Name;
	    	     storage5["lishique5fractionPe5"] = fractionPe;
	    	     storage5["lishique5percentage5"] = percentage;
	    	     storage5["lishique5correctnumber5"] = correctnumber;
	    	     storage5["lishique5int_second5"] = int_second;
	    	     storage5["lishique5queanswer5"] = queanswer;
	    	     storage5["lishique5answers5"] = answers;
	    	     storage5["lishique5andays5"] = dayss;
	    	     storage5["lishique5integral5"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["lishiAddintegral5"] == null || storage["lishiAddintegral5"] == ""){
							$.ajax({
						...
						var  Addintegral5 =  "lishiAddintegral5";
		    	    	 storage["lishiAddintegral5"] = Addintegral5;
	         ...
	         if(Knowledge_Name == "药学专业知识二"){
	        	/*  alert("将数据进行缓存："+Knowledge_Name); */
	    	     ...
	    	     storage6["lishique6Knowledge_Name6"] = Knowledge_Name;
	    	     storage6["lishique6fractionPe6"] = fractionPe;
	    	     storage6["lishique6percentage6"] = percentage;
	    	     storage6["lishique6correctnumber6"] = correctnumber;
	    	     storage6["lishique6int_second6"] = int_second;
	    	     storage6["lishique6queanswer6"] = queanswer;
	    	     storage6["lishique6answers6"] = answers;
	    	     storage6["lishique6andays6"] = dayss;
	    	     storage6["lishique6integral6"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["lishiAddintegral6"] == null || storage["lishiAddintegral6"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral6 =  "lishiAddintegral6";
		    	    	storage["lishiAddintegral6"] = Addintegral6;
	         ...
	         if(Knowledge_Name == "药学综合知识与技能" ){
	    	     ...
	    	     storage7["lishique7Knowledge_Name7"] = Knowledge_Name;
	    	     storage7["lishique7fractionPe7"] = fractionPe;
	    	     storage7["lishique7percentage7"] = percentage;
	    	     storage7["lishique7correctnumber7"] = correctnumber;
	    	     storage7["lishique7int_second7"] = int_second;
	    	     storage7["lishique7queanswer7"] = queanswer;
	    	     storage7["lishique7answers7"] = answers;
	    	     storage7["lishique7andays7"] = dayss;
	    	     storage7["lishique7integral7"] = integral;
	    	     ...
	    	     if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["lishiAddintegral7"] == null || storage["lishiAddintegral7"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral7 =  "lishiAddintegral7";
		    	    	 storage["lishiAddintegral7"] = Addintegral7;
	    	...
	    	if(Knowledge_Name == "药事管理与法规" ){
	        	  ...
	        	  storage8["lishique8Knowledge_Name8"] = Knowledge_Name;
	        	  storage8["lishique8fractionPe8"] = fractionPe;
	        	  storage8["lishique8percentage8"] = percentage;
	        	  storage8["lishique8correctnumber8"] = correctnumber;
	        	  storage8["lishique8int_second8"] = int_second;
	        	  storage8["lishique8queanswer8"] = queanswer;
	        	  storage8["lishique8answers8"] = answers;
	        	  storage8["lishique8andays8"] = dayss;
	        	  storage8["lishique8integral8"] = integral;
	        	  ...
	        	  if(percentage <= 40){
	    	       ...
	    	       if(percentage >= 50){
	    	    	   if(storage["lishiAddintegral8"] == null || storage["lishiAddintegral8"] == ""){
							$.ajax({
								url:'../mall/Addintegral',
								dataType:'json',
								type:'post',
						...
						var  Addintegral8 =  "lishiAddintegral8";
		    	    	 storage["lishiAddintegral8"] = Addintegral8;
    ...
    function jiexis(Knowledge_Names){
    	...
    	alert("点击的题型："+Knowledge_Name); */
    	 if("药学专业知识一" == Knowledge_Names){
	    	/* alert("已经进入中药学专业知识一"); */
		     ...
		     if(!storage5["lishique5int_second5"] ||  storage5["lishique5int_second5"] == 0){
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     var YXY = "YXY";
					  			 var  kemuZYHXY = "西药";
					  		     window.location.href="../lishicuotikemuzhangjie/lishicuotikemuzhangjie?kemu="+YXY+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
							    ...
							    /*  var dateTime = $(".dateTime").text(); */
							     ...
							     storage5["lishique5queanswer5"] = queanswer;
							     storage5["lishique5answers5"] = answers;
							     storage5["lishique5andays5"] = days;
							     storage5["lishique5integral5"] = integral;
		     ...
		     if(storage5["lishique5int_second5"] &&  storage5["lishique5int_second5"] != 0){
		    	 ...
		    	 var getKnowledge_Name = storage5["lishique5Knowledge_Name5"];
		    	 var getfractionPe = storage5["lishique5fractionPe5"];
		    	 var getpercentage = storage5["lishique5percentage5"];
		    	 var getcorrectnumber = storage5["lishique5correctnumber5"];
		    	 var getint_second = storage5["lishique5int_second5"];
		    	 var getqueanswer = storage5["lishique5queanswer5"];
		    	 var getanswers = storage5["lishique5answers5"];
		    	 var getdays = storage5["lishique5andays5"];
		    	 var getintegral  = storage5["lishique5integral5"];
     ...
     if("药学专业知识二" == Knowledge_Names){
	     ...
	     var storage6 = window.localStorage;
	     if(!storage6["lishique6int_second6"] || storage6["lishique6int_second6"] == 0 ){
					popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						  var button = $(e.target).attr('class');
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../lishicuotikemuzhangjie/lishicuotikemuzhangjie?kemu="+YXE+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
								 if($(".Knowledge_Name").text() == "药学专业知识二"){
								    ...
								    /*  var dateTime = $(".dateTime").text(); */
								     ...
								     storage6["lishique6queanswer6"] = queanswer;
								     storage6["lishique6answers6"] = answers;
								     storage6["lishique6andays6"] = days;
								     storage6["lishique6integral6"] = integral;
								     /* storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
	     ...
	     if(storage6["lishique6int_second6"] &&  storage6["lishique6int_second6"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage6["lishique6Knowledge_Name6"];
	    	 var getfractionPe = storage6["lishique6fractionPe6"];
	    	 var getpercentage = storage6["lishique6percentage6"];
	    	 var getcorrectnumber = storage6["lishique6correctnumber6"];
	    	 var getint_second = storage6["lishique6int_second6"];
	    	 var getqueanswer = storage6["lishique6queanswer6"];
	    	 var getanswers = storage6["lishique6answers6"]
	    	 var getdays = storage6["lishique6andays6"];
	    	 var getintegral = storage6["lishique6integral6"];
	    	 var getdateTime = storagedateTime["lishistoragedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","block");
     ...
     if("药学综合知识与技能" == Knowledge_Names){
    	 //设置localStorage用于页面的本地储存(将数据存入storage中去)
	     var storage7 = window.localStorage;
	     if(!storage7["lishique7int_second7"] || storage7["lishique7int_second7"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
							...
							setTimeout(function() {
								/*  webToast("操作成功","top", 6000);  */
								 ...
								 var  lv1state = $(".lv1state").text();//礼物领取状态
					  		     ...
					  		     window.location.href="../lishicuotikemuzhangjie/lishicuotikemuzhangjie?kemu="+YXZH+"&kemuZYHXY="+kemuZYHXY+"&openid="+openid+"&headimgurl="+headimgurl+"&nickname="+nickname+"&days="+days+"&integral="+integral+"&dateTime="+dateTime+"&lv1state="+lv1state+"&lv2state="+lv2state+"&lv3state="+lv3state+""; 
								if($(".Knowledge_Name").text() == "药学综合知识与技能"){
							     ...
							     storage7["lishique7queanswer7"] = queanswer;
							     storage7["lishique7answers7"] = answers;
							     storage7["lishique7andays7"] = days;
							     storage7["lishique7integral7"] = integral;
							    /*  storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
							     $("#active1").css("display","none");
							     $("#active2").css("display","none");
	     ...
	     if(storage7["lishique7int_second7"] &&  storage7["lishique7int_second7"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage7["lishique7Knowledge_Name7"];
	    	 var getfractionPe = storage7["lishique7fractionPe7"];
	    	 var getpercentage = storage7["lishique7percentage7"];
	    	 var getcorrectnumber = storage7["lishique7correctnumber7"];
	    	 var getint_second = storage7["lishique7int_second7"];
	    	 var getqueanswer = storage7["lishique7queanswer7"];
	    	 var getanswers = storage7["lishique7answers7"];
	    	 var getdays = storage7["lishique7andays7"];
	    	 var getintegral = storage7["lishique7integral7"] ;
	         var getdateTime = storagedateTime["lishistoragedateTime"]; 
	         $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
     ...
     if("药事管理与法规" == Knowledge_Names){
    	 var storage8 = window.localStorage;
	     if(!storage8["lishique8int_second8"] || storage8["lishique8int_second8"] == 0){
				popTipShow.confirm('提示','今日没有答题记录哦',['去答题','不想做'],
						function(e){ 
						  //callback 处理按钮事件
						   var button = $(e.target).attr('class');
						  if(button == 'ok'){ 
							...
							setTimeout(function() { 
								/*  webToast("操作成功","top", 6000);  */
							     ...
							     storage8["lishique8queanswer8"] = queanswer;
							     storage8["lishique8answers8"] = answers;
							     storage8["lishique8andays8"] = days;
							     storage8["lishique8integral8"] = integral;
							     /* storagedateTime["storagedateTime"] =  dateTime; *///将当前时间保存进缓存
							     $("#active1").css("display","none");
							     $("#active2").css("display","none");
	     ...
	     if(storage8["lishique8int_second8"] &&  storage8["lishique8int_second8"] != 0){
	    	 var storagedateTime = window.localStorage;
	    	 var getKnowledge_Name = storage8["lishique8Knowledge_Name8"];
	    	 var getfractionPe = storage8["lishique8fractionPe8"];
	    	 var getpercentage = storage8["lishique8percentage8"];
	    	 var getcorrectnumber = storage8["lishique8correctnumber8"];
	    	 var getint_second = storage8["lishique8int_second8"];
	    	 var getqueanswer = storage8["lishique8queanswer8"];
	    	 var getanswers = storage8["lishique8answers8"];
	    	 var getdays = storage8["lishique8andays8"];
	    	 var getintegral = storage8["lishique8integral8"] ;
	    	 var getdateTime = storagedateTime["lishistoragedateTime"];
	    	 $(".Knowledge_Name").text(getKnowledge_Name);//题型名
	    	 $("#active1").css("display","none");
		     $("#active2").css("display","none");
	  ...
	  var  lv3state = $(".lv3state").text();//礼物领取状态
      var storagedateTime = window.localStorage;
      var dateTime = storagedateTime["lishistoragedateTime"];//当前登录时间
      //查看排行榜(排行榜点击事件)
      function ranking(){
							  ...
							  if(button == 'ok'){
								...
								setTimeout(function(){
									 $("#lw3").css("background-color","#C0C0C0");
						  		    	...
						  		    	var storage7 = window.localStorage;
						  		    	var storage8 = window.localStorage;
						  		    	storage5["lishique5integral5"] = data.integral;
						  		    	storage6["lishique6integral6"] = data.integral;
						  		    	storage7["lishique7integral7"] = data.integral;
						  		    	storage8["lishique8integral8"] = data.integral;
